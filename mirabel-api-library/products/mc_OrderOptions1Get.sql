/*
 =============================================
 API Documentation
 Description:    Retrieves advertisement size information with optional filtering
 ...
 Example Usage:
 EXEC [mc_OrderOptions1Get] @RateCardID = '', @ProductID = '', @PageNumber = '1'
 EXEC [mc_OrderOptions1Get] @RateCardID = '1', @ProductID = '', @PageNumber = '1'
 EXEC [mc_OrderOptions1Get] @RateCardID = '', @ProductID = '25', @PageNumber = '1'

*/
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[mc_OrderOptions1Get]
(
...
AS
BEGIN
    -- Returns advertisement size options with the correct label
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        SELECT DISTINCT 
            a.gsAdSizeID AS ID,
            a.AdSizeName as [Value],
            e.SubProductType AS ProductType,
            f.Label
        FROM gsAdsize a
        LEFT OUTER JOIN tblratecard2adsize c ON a.gsAdsizeID = c.AdSizeID
