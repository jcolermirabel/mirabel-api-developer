/*
 =============================================
 API Documentation--mc_OrderOptions4Get
 Description:    Retrieves advertisement position information with optional filtering
 ...
 Example Usage:
 EXEC [mc_OrderOptions4Get] @RateCardID = '', @ProductID = '', @PageNumber = '1'
 EXEC [mc_OrderOptions4Get] @RateCardID = '7', @ProductID = '', @PageNumber = '1'
 EXEC [mc_OrderOptions4Get] @RateCardID = '', @ProductID = '25', @PageNumber = '1'
 =============================================
*/
CREATE OR ALTER PROCEDURE [dbo].[mc_OrderOptions4Get]
(
...
AS
BEGIN
    -- Returns advertisement position options with the correct label
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        SELECT DISTINCT 
            ...
            f.Label
        FROM gsAdPosition a
        LEFT OUTER JOIN tblratecard2adposition c ON a.PositionID = c.PositionID
        ...
        LEFT JOIN tblProductTypeFieldLabel f ON e.subproducttypeID = f.subproducttypeID 
            AND producttypefieldcode = 'AdPosition'
        WHERE e.isenabled = 1
